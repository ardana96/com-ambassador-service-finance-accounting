...
namespace Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.BudgetCashflow
{
    public class CashflowUnitFormDto : IValidatableObject
    {
        public int UnitId { get; set; }
        public int DivisionId { get; set; }
        public DateTimeOffset Date { get; set; }
        public List<CashflowUnitItemFormDto> Items { get; set; }
        public int CashflowSubCategoryId { get; set; }
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (CashflowSubCategoryId <= 0)
            {
                yield return new ValidationResult("Sub Kategori harus diisi", new List<string> { "CashflowSubCategoryId" });
            }
