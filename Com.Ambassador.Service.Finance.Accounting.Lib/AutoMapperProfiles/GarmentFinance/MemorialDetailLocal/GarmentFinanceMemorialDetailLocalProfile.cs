...
namespace Com.Ambassador.Service.Finance.Accounting.Lib.AutoMapperProfiles.GarmentFinance.MemorialDetailLocal
{
    public class GarmentFinanceMemorialDetailLocalProfile : Profile
    {
        public GarmentFinanceMemorialDetailLocalProfile()
        {
            CreateMap<GarmentFinanceMemorialDetailLocalModel, GarmentFinanceMemorialDetailLocalViewModel>()
            ...
            CreateMap<GarmentFinanceMemorialDetailLocalItemModel, GarmentFinanceMemorialDetailLocalItemViewModel>()
            ...
            CreateMap<GarmentFinanceMemorialDetailLocalOtherItemModel, GarmentFinanceMemorialDetailLocalOtherItemViewModel>()
                .ForPath(d => d.Currency.Id, opt => opt.MapFrom(s => s.CurrencyId))
                .ForPath(d => d.Currency.Code, opt => opt.MapFrom(s => s.CurrencyCode))
                .ForPath(d => d.Currency.Rate, opt => opt.MapFrom(s => s.CurrencyRate))
