...
namespace Com.Ambassador.Service.Finance.Accounting.Lib.Migrations
{
    ...
    [Migration("20190131041636_Add_PayToSupplier_PurchasingDispositionExpedition")]
    partial class Add_PayToSupplier_PurchasingDispositionExpedition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Com.Ambassador.Service.Finance.Accounting.Lib.Models.PaymentDispositionNote.PaymentDispositionNoteDetailModel", b =>
                {
                    b.HasOne("Com.Ambassador.Service.Finance.Accounting.Lib.Models.PaymentDispositionNote.PaymentDispositionNoteModel", "PaymentDispositionNoteItem")
                        .WithMany()
                        .HasForeignKey("PaymentDispositionNoteItemId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Com.Ambassador.Service.Finance.Accounting.Lib.Models.PaymentDispositionNote.PaymentDispositionNoteItemModel")
                        .WithMany("Details")
