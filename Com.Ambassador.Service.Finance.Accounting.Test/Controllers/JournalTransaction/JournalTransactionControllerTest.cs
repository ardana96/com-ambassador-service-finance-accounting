...
using Com.Ambassador.Service.Finance.Accounting.WebApi.Controllers.v1.JournalTransaction;
using Moq;
using System;
...
namespace Com.Ambassador.Service.Finance.Accounting.Test.Controllers.JournalTransaction
{
