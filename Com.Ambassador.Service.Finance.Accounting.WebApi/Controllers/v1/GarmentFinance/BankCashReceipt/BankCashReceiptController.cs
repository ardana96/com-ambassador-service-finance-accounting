...
namespace Com.Ambassador.Service.Finance.Accounting.WebApi.Controllers.v1.GarmentFinance.BankCashReceipt
{
    [Produces("application/json")]
    [ApiVersion("1.0")]
    [Route("v{version:apiVersion}/bank-cash-receipts")]
    [Authorize]
    public class BankCashReceiptController : Controller
    {
        private IIdentityService IdentityService;
        private readonly IValidateService ValidateService;
        private readonly IBankCashReceiptService Service;
        private readonly string ApiVersion;
        private readonly IMapper Mapper;

        public BankCashReceiptController(IIdentityService identityService, IValidateService validateService, IMapper mapper, IBankCashReceiptService service)
        {
        ...
        public IActionResult Get(int page = 1, int size = 25, string order = "{}", [Bind(Prefix = "Select[]")] List<string> select = null, string keyword = null, string filter = "{}")
        {
            try
            {
                ReadResponse<BankCashReceiptModel> read = Service.Read(page, size, order, select, keyword, filter);

                List<BankCashReceiptViewModel> dataVM = Mapper.Map<List<BankCashReceiptViewModel>>(read.Data);
