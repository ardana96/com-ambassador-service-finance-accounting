...
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.DPPVATBankExpenditureNote;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingExpedition;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingExpedition.Reports;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CashierApproval;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.ClearaceVB;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CreditBalance;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.CreditorAccount;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.DailyBankTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentInvoicePayment;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.JournalTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.LockTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.Master;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PaymentDispositionNote;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PaymentDispositionNotVerifiedReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.PurchasingDispositionExpedition;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.SalesReceipt;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBExpeditionRealizationReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBRealizationDocumentNonPO;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBRequestAll;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.VBStatusReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.CashierApproval;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.ClearaceVB;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.CreditBalance;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.CreditorAccount;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.DailyBankTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.DownPayment;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentInvoicePayment;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.JournalTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.LockTransaction;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.Master;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.Memo;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.PaymentDispositionNote;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.PaymentDispositionNotVerifiedReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.PurchasingDispositionExpedition;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.RealizationVBNonPO;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.SalesReceipt;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBExpeditionRealizationReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VbNonPORequest;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBRealizationDocumentNonPO;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBRequestAll;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBStatusReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.VBVerification;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.VBRealizationDocument;
...
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.VbWIthPORequest;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentPurchasingPphBankExpenditureNote;
using Com.Ambassador.Service.Finance.Accounting.Lib.Services.CacheService;
...
using Com.Ambassador.Service.Finance.Accounting.Lib.Services.OthersExpenditureProofDocument;
...
using System.Linq;
using System.Text;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDebtBalance;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDispositionExpedition;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentInvoicePurchasingDisposition;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDispositionPaymentReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.AccountingBook;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.MemoGarmentPurchasing;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoGarmentPurchasing;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoDetailGarmentPurchasing;
using Microsoft.ApplicationInsights.AspNetCore;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.MemoGarmentPurchasingReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.MemoGarmentPurchasingReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentDownPaymentReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceipt;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.BankCashReceipt;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.PurchasingMemoDetailTextile;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Reports.ExportSalesDebtorReport;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Reports;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceiptDetail;
...
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Memorial;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.MemorialDetail;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.BankCashReceiptDetailLocal;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.BankCashReceiptDetailLocal;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.GarmentFinance.MemorialDetailLocal;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Services.GarmentFinance.MemorialDetailLocal;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.DebtorCard;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.BankCashReceiptMonthlyRecap;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.ExportSalesOutstanding;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.GarmentFinance.Reports.LocalSalesOutstanding;
using Com.Ambassador.Service.Finance.Accounting.Lib.BusinessLogic.Interfaces.Reports.LocalSalesDebtorReport;
